...
Light = {
	Name = "Light",
	Accent = Color3.fromRGB(180, 0, 255), -- ม่วงนีออนเรืองแสง
	AcrylicMain = Color3.fromRGB(60, 0, 90),
	AcrylicBorder = Color3.fromRGB(100, 0, 140),
	AcrylicGradient = ColorSequence.new(Color3.fromRGB(180, 0, 255), Color3.fromRGB(100, 0, 140)),
	AcrylicNoise = 0.92,
	TitleBarLine = Color3.fromRGB(120, 0, 180),
	Tab = Color3.fromRGB(140, 0, 200),
	Element = Color3.fromRGB(230, 200, 255),
	ElementBorder = Color3.fromRGB(180, 0, 255),
	InElementBorder = Color3.fromRGB(120, 0, 180),
	ElementTransparency = 0.35,
	ToggleSlider = Color3.fromRGB(90, 0, 130),
	ToggleToggled = Color3.fromRGB(220, 0, 255),
	SliderRail = Color3.fromRGB(60, 0, 90),
	DropdownFrame = Color3.fromRGB(80, 0, 110),
	DropdownHolder = Color3.fromRGB(120, 0, 160),
	DropdownBorder = Color3.fromRGB(180, 0, 255),
	DropdownOption = Color3.fromRGB(220, 190, 255),
	Keybind = Color3.fromRGB(160, 0, 220),
	Input = Color3.fromRGB(210, 180, 255),
	InputFocused = Color3.fromRGB(200, 0, 255),
	InputIndicator = Color3.fromRGB(140, 0, 200),
	InputIndicatorFocus = Color3.fromRGB(255, 0, 255),
	Dialog = Color3.fromRGB(240, 220, 255),
	DialogHolder = Color3.fromRGB(80, 0, 100),
	DialogHolderLine = Color3.fromRGB(160, 0, 200),
	DialogButton = Color3.fromRGB(180, 0, 255),
	DialogButtonBorder = Color3.fromRGB(220, 0, 255),
	DialogBorder = Color3.fromRGB(100, 0, 180),
	DialogInput = Color3.fromRGB(240, 200, 255),
	DialogInputLine = Color3.fromRGB(180, 0, 255),
	Text = Color3.fromRGB(255, 255, 255), -- ตัวอักษรสีขาว
